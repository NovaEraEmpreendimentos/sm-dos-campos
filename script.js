...
function generatePrintContent() {
    ...
    printContent.innerHTML = `
        ...
        <div class="print-contact">
            <p><strong>Telefone:</strong> (82) 9 9331-2300 | <strong>Instagram:</strong> @gilliardcred</p>
            <p>Endereço: R. Dr. Rômulo de almeida 144, Vizinho a Magazine Luiza<br>São Miguel dos Campos - AL</p>
        </div>
    `;
}
